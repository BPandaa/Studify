  ...
  return (
    <section className="max-w-5xl mx-auto py-16 px-8" id="pricing">
      ...
      <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <svg className="w-6 h-6 text-amber-500" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0..." clipRule="evenodd" />
              </svg>
            </div>
            ...
            <ul className="mb-8 space-y-3">
              <li className="flex items-start">
                <svg className="w-5 h-5 text-green-600 mr-2 mt-0.5" viewBox="0 0 24 24">
        ...
        {/* Premium Card */}
        <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:translate-y-[-4px] border-t-4 border-amber-600">
          <div className="p-6">
            ...
            <button
              ...
              className="block w-full py-3 text-center bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-lg transition-colors duration-200 group"
            >
              Get Premium Access
